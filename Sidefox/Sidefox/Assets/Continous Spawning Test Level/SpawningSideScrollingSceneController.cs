...
public class SpawningSideScrollingSceneController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(EnemySpawnTimer <= 0)
        {
            ...
            if (EnemySpawnType == 0)
            {
                ...
                Instantiate(Enemy, Camera.main.ScreenToWorldPoint(new Vector3(1.1f, randomHeight, 10f)), Quaternion.identity);
            ...
            if(EnemySpawnType == 1)
            {
                ...
                int TopOrBottom = 2;//Random.Range(1,3);
            ...
            if (EnemySpawnType == 2)
            {
                ...
                Instantiate(Enemy, new Vector3((float)StartPoint, -5f, 0f), Quaternion.identity);
             //   Enemy.GetComponent<Enemy_1>().EnemyMovementPattern = 3;
            }

            if (EnemySpawnType == 3)
            {
                int StartPoint = 15;//Random.Range(8, 12);
